...
import { NavigationEnd, PRIMARY_OUTLET, RouterEvent } from "@angular/router";
  ...
  getMenuItems(): MenuItem[] {
    return [
      ...
      new MenuItem(
        ...
        "",
        "fas fa-folder-open",
        PERMISSIONS_CONSTANT.TabCategory,
        [
          new MenuItem(
            "Education Types",
      ...
      new MenuItem(
        ...
        "",
        "fas fa-file-audio",
        PERMISSIONS_CONSTANT.TabRequisition,
        [
          new MenuItem(
            "Staff",
      ...
      new MenuItem(
        "Candidate Interview",
        "/app/candidate/interview-list",
        "fas fa-user-tag",
        PERMISSIONS_CONSTANT.TabInterview
      ),
      new MenuItem(
        "Candidate Offer",
        "/app/candidate/offer-list",
        "fas fa-handshake",
        PERMISSIONS_CONSTANT.TabOffers
      ),
      new MenuItem(
        "Candidate Onboard",
        "/app/candidate/onboard-list",
        "fas fa-briefcase",
        PERMISSIONS_CONSTANT.TabOnboard
      ),
      new MenuItem(
        "Report",
        "",
        "fas fa-chart-line",
        PERMISSIONS_CONSTANT.TabReport,
        [
          new MenuItem(
      ...
      new MenuItem(
        this.l("Employee Profile"),
        "",
        "fas fa-user-cog",
        PERMISSIONS_CONSTANT.TabFakeCV,
        [
          new MenuItem(
            this.l("My Profile"),
      ...
      new MenuItem(
        "Guideline",
        "https://docs.google.com/document/d/1wzMDnhIJCWGQ6cPlr4T5wEm4H64UcVYgw5abbOJfFDw",
        "fas fa-book"
      ),
    ];
  }
