...
import { mergeMap as _observableMergeMap, catchError as _observableCatch, map, startWith, catchError } from 'rxjs/operators';
...
export class UserServiceProxy {
    ...
    getAllUser(): Observable<any> {
        return this.http.get<any>(this.baseUrl + '/api/services/app/User/GetAllUser');
    }
    ...
    update(body: UserDto | undefined): Observable<UserDto> {
        ...
        // Workaround because JSON.stringify not work with dome
        let content_ = JSON.stringify(body);
        if (body.signatureContact) {
            const element = document.createElement('section');
            element.innerHTML = body.signatureContact;
            const obj = { ...body, signatureContact: element.innerHTML };
            content_ = JSON.stringify(obj);
        }
     ...
     * @return Success
     */
    upLoadOwnAvatar(file: File): Observable<AvatarDto> {
        const formData = new FormData();
        formData.append('file', file);
        let url_ = this.baseUrl + "/api/services/app/User/UpdateYourOwnAvatar";
        let options_: any = {
            observe: "response",
            responseType: "blob",
            headers: new HttpHeaders({
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AvatarDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<AvatarDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAvatar(response: HttpResponseBase): Observable<AvatarDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = AvatarDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AvatarDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ApiResponse<UserDto>> {
        let url_ = this.baseUrl + `/api/services/app/User/Get?Id=${id}`;
     ...
     * @return Success
     */
    getAll(request: PagedRequestDto): Observable<UserDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/User/GetAllPaging";
        let options_: any = {
            observe: "response",
            responseType: "blob",
            headers: new HttpHeaders({
...
export class UserDto implements IUserDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.creationTime = _data["creationTime"] ? moment(_data["creationTime"].toString()) : <any>undefined;
            this.signatureContact = _data["signatureContact"];
            this.branchId = _data["branchId"];
    ...
    toJSON(data?: any) {
        ...
        data["creationTime"] = this.creationTime ? this.creationTime.toISOString() : <any>undefined;
        data["signatureContact"] = this.signatureContact;
        data["branchId"] = this.branchId;
...
export class AvatarDto implements IAvatarDto {
    ...
    static fromJS(data: any): AvatarDto {
        data = typeof data === 'object' ? data : {};
