...
{
    [AbpAuthorize]
    public class CandidateStaffAppService : TalentV2AppServiceBase
    {
        private readonly ICandidateManager _candidateManager;
        private readonly IRequisitionManager _requisitionManager;
        public CandidateStaffAppService(ICandidateManager candidateManager, IRequisitionManager requisitionManager) 
        {
        ...
        [HttpPost]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewList)]
        ...
        [HttpPost]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_Create)]
        ...
        [HttpGet]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_PersonInfo_View)]
        public async Task<PersonBioDto> GetCVById(long cvId)
        {
            return await _candidateManager.GetCVById(cvId);
        }
        [HttpGet]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Education_ViewList)]
        ...
        [HttpGet]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Skill_ViewList)]
        ...
        [HttpGet]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV)]
        ...
        [HttpPost]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_Create)]
        ...
        [HttpPost]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Skill_Create)]
        ...
        [HttpPut]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Skill_Edit)]
        ...
        [HttpDelete]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Skill_Delete)]
        public async Task<string> DeleteSkillCV(long id)
        {
            await _candidateManager.DeleteSkillCV(id);
            return "Deleted Successfully";
        }
        [HttpPost]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Education_Create)]
        ...
        //[HttpPut]
        //[AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Education_Edit)]
        ...
        //}
        [HttpDelete]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_Education_Delete)]
        ...
        [HttpPost]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_ViewEditInterview)]
        ...
        [HttpPut]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_EditCapability)]
        ...
        [HttpPut]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_EditFactorCapabilityResult)]
        public async Task<List<CapabilityCandidateDto>> UpdateManyFatorsCapabilityCV(List<UpdateCapabilityCandidateDto> input)
        {
            return await _candidateManager.UpdateFactorsCapabilityCV(input);
        }
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_EditApplicationResult)]
        ...
        [HttpDelete]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_Delete)]
        ...
        {
            return await _candidateManager.GetUserCreated(UserType.Staff);
        }
        [HttpDelete]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_Delete)]
        ...
        [HttpPut]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_ViewEditInterview)]
        public async Task<string> UpdateInterviewTime(UpdateInterviewTimeDto input)
        {
        ...
        [HttpGet]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_Clone)]
        ...
        [HttpPut]
        [AbpAuthorize(PermissionNames.Pages_CandidateStaff_ViewDetail_RequestCV_EditInterviewLevel)]
