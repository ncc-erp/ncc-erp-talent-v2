...
namespace TalentV2.DomainServices.Reports
{
    public interface IReportManager : IDomainService
    {
        ...
        Task<ReportEducationByBranchDto<CandidateQuantityInUniversity>> GetCandidateQuantityInUniversity(DateTime fd, DateTime td, long? branchId, UserType? userType = UserType.Intern);
    }
}
