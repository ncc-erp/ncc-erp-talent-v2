...
{
    public class FileEmployeeService : IFileEmployeeService
    {
        private readonly string FOLDER_SERVICE = "employees";
        private readonly IAbpSession _session;
        private readonly IFileProvider _fileService;
        private readonly IFilePath _filePath;
        public FileEmployeeService(IAbpSession session, IFileProvider fileService, IFilePath filePath)
        {
            _session = session;
