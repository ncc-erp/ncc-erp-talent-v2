...
namespace TalentV2.NccCore
{
    public class WorkScope : ApplicationService, IWorkScope
    {
        ...
        async Task<TPrimaryKey> IWorkScope.InsertAndGetIdAsync<TEntity, TPrimaryKey>(TEntity entity)
        {
            ...
            UpdateLastModified<TEntity, TPrimaryKey>(entity);
        ...
        private void UpdateLastModified<TEntity, TPrimaryKey>(TEntity entity) where TEntity : class, IEntity<TPrimaryKey>
        {
            ...
            PropertyInfo lastModifiedUserId = entityType.GetProperty("LastModifierUserId");
            if (lastModifiedUserId != null)
            {
                lastModifiedUserId.SetValue(entity, AbpSession.UserId);
            }
        }
            ...
            where TEntityDto : class, IEntityDto<TPrimaryKey>
        {
            ...
            foreach (var itemDto in insertItemDtos)
            {
                ...
                UpdateLastModified<TEntity, TPrimaryKey>(item);
