        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Certificates = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    PersonalAttribute = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbpUsers_EmployeePositions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    GroupSkillId = table.Column<long>(type: "bigint", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FakeSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FakeSkills_GroupSkills_GroupSkillId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Capabilities_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Capabilities_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CVSources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CVSources_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CVSources_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EducationsTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EducationsTypes_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EducationsTypes_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailTemplates_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmailTemplates_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    CVEmployeeId = table.Column<long>(type: "bigint", nullable: true),
                    SchoolOrCenterName = table.Column<string>(type: "text", nullable: true),
                    DegreeType = table.Column<int>(type: "integer", nullable: false),
                    Major = table.Column<string>(type: "text", nullable: true),
                    StartYear = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: true),
                    EndYear = table.Column<string>(type: "character varying(4)", maxLength: 4, nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeEducations_AbpUsers_CVEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubPositions_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SubPositions_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Versions_AbpUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Versions_EmployeeLanguages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "EmployeeLanguages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Versions_EmployeePositions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "EmployeePositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExperienceMonth = table.Column<int>(type: "integer", nullable: false),
                    GroupSkillId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeSkills_AbpUsers_CVEmployeeId",
                        column: x => x.CVEmployeeId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmployeeSkills_FakeSkills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "FakeSkills",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmployeeSkills_GroupSkills_GroupSkillId",
                        column: x => x.GroupSkillId,
                        principalTable: "GroupSkills",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Educations_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Educations_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CapabilitySettings_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CapabilitySettings_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CapabilitySettings_SubPositions_SubPositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CVStatus = table.Column<byte>(type: "smallint", nullable: false),
                    CVSourceId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CVs_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CVs_CVSources_CVSourceId",
                        column: x => x.CVSourceId,
                        principalTable: "CVSources",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CVs_SubPositions_SubPositionId",
                        column: x => x.SubPositionId,
                        principalTable: "SubPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserType = table.Column<int>(type: "integer", nullable: false),
                    SubPositionId = table.Column<long>(type: "bigint", nullable: false),
                    LMSCourseName = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    LMSCourseId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProjectInfo = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    DiscordInfo = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IMSInfo = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PositionSettings_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PositionSettings_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PositionSettings_SubPositions_SubPositionId",
                        column: x => x.SubPositionId,
                        principalTable: "SubPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeNeed = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_SubPositions_SubPositionId",
                        column: x => x.SubPositionId,
                        principalTable: "SubPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeWorkingExperiences_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkingExperiences_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmployeeWorkingExperiences_Versions_VersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CVEducations_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CVEducations_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CVSkills_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CVSkills_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmailStatusHistories_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmailStatusHistories_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmailStatusHistories_CVs_CVId",
                        column: x => x.CVId,
                        principalTable: "CVs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmailStatusHistories_EmailTemplates_EmailTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    InterviewTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    OnboardDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Salary = table.Column<float>(type: "real", nullable: false),
                    LMSInfo = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    CVId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestSkills_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestSkills_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "EmployeeWorkingExpAndTechnologies",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    WorkingExpId = table.Column<long>(type: "bigint", nullable: false),
                    TechnologyId = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeWorkingExpAndTechnologies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkingExpAndTechnologies_EmployeeWorkingExperience~",
                        column: x => x.WorkingExpId,
                        principalTable: "EmployeeWorkingExperiences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkingExpAndTechnologies_Technologies_TechnologyId",
                        column: x => x.TechnologyId,
                        principalTable: "Technologies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "RequestCVCapabilityResults",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestCVCapabilityResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestCVCapabilityResults_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestCVCapabilityResults_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestCVCapabilityResults_Capabilities_CapabilityId",
                        column: x => x.CapabilityId,
                        principalTable: "Capabilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestCVCapabilityResults_RequestCVs_RequestCVId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestCVInterviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestCVInterviews_AbpUsers_InterviewId",
                        column: x => x.InterviewId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestCVInterviews_RequestCVs_RequestCVId",
                        column: x => x.RequestCVId,
                        principalTable: "RequestCVs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    TimeAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    RequestCVId = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestCVStatusHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestCVStatusHistories_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestCVStatusHistories_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestCVStatusHistories_RequestCVs_RequestCVId",
                        column: x => x.RequestCVId,
                        principalTable: "RequestCVs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Capabilities_CreatorUserId",
                table: "Capabilities",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Capabilities_LastModifierUserId",
                table: "Capabilities",
                column: "LastModifierUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CapabilitySettings_CreatorUserId",
                table: "CapabilitySettings",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CapabilitySettings_LastModifierUserId",
                table: "CapabilitySettings",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CapabilitySettings_SubPositionId",
                table: "CapabilitySettings",
                column: "SubPositionId");

            migrationBuilder.CreateIndex(
                name: "IX_CVEducations_CreatorUserId",
                table: "CVEducations",
                column: "CreatorUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVEducations_LastModifierUserId",
                table: "CVEducations",
                column: "LastModifierUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVSkills_CreatorUserId",
                table: "CVSkills",
                column: "CreatorUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVSkills_LastModifierUserId",
                table: "CVSkills",
                column: "LastModifierUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVSources_CreatorUserId",
                table: "CVSources",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CVSources_LastModifierUserId",
                table: "CVSources",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Educations_CreatorUserId",
                table: "Educations",
                column: "CreatorUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Educations_LastModifierUserId",
                table: "Educations",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationsTypes_CreatorUserId",
                table: "EducationsTypes",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationsTypes_LastModifierUserId",
                table: "EducationsTypes",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailStatusHistories_CreatorUserId",
                table: "EmailStatusHistories",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailStatusHistories_CVId",
                table: "EmailStatusHistories",
                column: "CVId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailStatusHistories_EmailTemplateId",
                table: "EmailStatusHistories",
                column: "EmailTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_EmailStatusHistories_LastModifierUserId",
                table: "EmailStatusHistories",
                column: "LastModifierUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeEducations_CVEmployeeId",
                table: "EmployeeEducations",
                column: "CVEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSkills_CVEmployeeId",
                table: "EmployeeSkills",
                column: "CVEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSkills_GroupSkillId",
                table: "EmployeeSkills",
                column: "GroupSkillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkingExpAndTechnologies_TechnologyId",
                table: "EmployeeWorkingExpAndTechnologies",
                column: "TechnologyId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkingExpAndTechnologies_WorkingExpId",
                table: "EmployeeWorkingExpAndTechnologies",
                column: "WorkingExpId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkingExperiences_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkingExperiences_VersionId",
                table: "EmployeeWorkingExperiences",
                column: "VersionId");

            migrationBuilder.CreateIndex(
                name: "IX_FakeSkills_GroupSkillId",
                table: "FakeSkills",
                column: "GroupSkillId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionSettings_CreatorUserId",
                table: "PositionSettings",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionSettings_LastModifierUserId",
                table: "PositionSettings",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PositionSettings_SubPositionId",
                table: "PositionSettings",
                column: "SubPositionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestCVCapabilityResults_CapabilityId",
                table: "RequestCVCapabilityResults",
                column: "CapabilityId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestCVCapabilityResults_CreatorUserId",
                table: "RequestCVCapabilityResults",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestCVCapabilityResults_LastModifierUserId",
                table: "RequestCVCapabilityResults",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestCVCapabilityResults_RequestCVId",
                table: "RequestCVCapabilityResults",
                column: "RequestCVId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestCVInterviews_InterviewId",
                table: "RequestCVInterviews",
                column: "InterviewId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestCVInterviews_RequestCVId",
                table: "RequestCVInterviews",
                column: "RequestCVId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestCVStatusHistories_CreatorUserId",
                table: "RequestCVStatusHistories",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestCVStatusHistories_LastModifierUserId",
                table: "RequestCVStatusHistories",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestCVStatusHistories_RequestCVId",
                table: "RequestCVStatusHistories",
                column: "RequestCVId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestSkills_CreatorUserId",
                table: "RequestSkills",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestSkills_LastModifierUserId",
                table: "RequestSkills",
                column: "LastModifierUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubPositions_CreatorUserId",
                table: "SubPositions",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SubPositions_LastModifierUserId",
                table: "SubPositions",
                column: "LastModifierUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Versions_EmployeeId",
                table: "Versions",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Versions_LanguageId",
                table: "Versions",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_Versions_PositionId",
                table: "Versions",
                column: "PositionId");
        }
