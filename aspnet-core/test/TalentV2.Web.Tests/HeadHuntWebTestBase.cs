...
{
    public abstract class HeadHuntWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HeadHuntWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HeadHuntWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<HeadHuntDbContext> action)
        {
            using (var context = IocManager.Resolve<HeadHuntDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<HeadHuntDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<HeadHuntDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HeadHuntDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HeadHuntDbContext, Task<T>> func)
        {
            T result;
